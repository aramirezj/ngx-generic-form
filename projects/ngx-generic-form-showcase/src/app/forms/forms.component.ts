...
export class FormsComponent {
  ...
  formProduct: GF_Form<any> = new GF_Form(GF_TypeForm.CREATION, ['code', 'name', 'type', 'stock', 'image'], ['Code', 'Full name', 'Type', 'Stock', 'Imagen'], 'Creating a product');
  ...
  createProduct() {
    ...
    this.formService.openForm(this.formProduct).subscribe(producto => {
